...
MEMORY
{
        /* Only use the 64kB internal SRAM for the bootloader, to allow for loading
           of programs into 64kB L3 OCMC SRAM as well as SDRAM */
...
SECTIONS
{
    ...
    .stack   : load > IRAM_MEM (HIGH)            /* SOFTWARE SYSTEM STACK        */
}
